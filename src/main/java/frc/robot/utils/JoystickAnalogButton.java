...
/**
 * This class allows you to trigger commands from an analog input on a joystick
 * (sich as the triggers - Axis 3).
 * 
 * 
 ...
 * JoystickAnalogButton TriggerR = new JoystickAnalogButton(joystickChannel, 3,
 * -0.5), TriggerL = new JoystickAnalogButton(joystickChannel, 3, 0.5)
 * 
