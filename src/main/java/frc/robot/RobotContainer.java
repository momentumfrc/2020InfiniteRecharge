...
public class RobotContainer {
  ...
  // ---------------------------------------Chooser---------------------------------------------
  private final PathChooser pathChooser = new PathChooser("paths/test.wpilib.json", "paths/forward2meters.wpilib.json",
      "paths/BarrelRacing.wpilib.json", "paths/Slalom.wpilib.json");
  ...
  public RobotContainer() {
    ...
    falconDriveSubsystem.setDefaultCommand(getTeleopCommand());
